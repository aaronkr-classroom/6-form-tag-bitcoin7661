			...
			<p>연락처: 
				<select name="p1">
				 ...
				 <p> 성별:
				 	...
				 	<input type="radio" name="gender" value="남성" checked>여성
				 </p>
				 
				 <p>취미:
				 	<input type="checkbox" name="hobby1" checked>독서
				 	<input type="checkbox" name="hobby1" checked>운동
				 	<input type="checkbox" name="hobby1" checked>게임
				 </p>
				 ...
				 <hr>
				 <p>
				 	<textarea name="comment" cols=30 rows=5>가입인사를 입력해주세요~~
				 		</textarea>
				 		</p>
